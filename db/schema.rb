...
ActiveRecord::Schema.define(version: 2023_03_31_151504) do
  ...
  create_table "after_sales", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "item_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_after_sales_on_item_id"
    t.index ["user_id"], name: "index_after_sales_on_user_id"
  end
